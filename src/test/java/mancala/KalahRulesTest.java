...
public class KalahRulesTest {
    ...
    public void testNoCapture() {
        try {
            rules.moveStones(1, 1);
            rules.moveStones(7,2);
        } catch (InvalidMoveException ex) {
            System.out.println("EXECPTION");
        }
        assertEquals(5, data.getNumStones(11));
        assertEquals(5, data.getNumStones(2));
    }
    ...
    public void testIsGameOver() {
        ...
        assertEquals(true, rules.isSideEmpty(1));
        //assertEquals(false, rules.isSideEmpty(7));
