...
public class AyoRulesTest {
    ...
    @Test
    public void testMove2_12_6() {
      try {
          rules.moveStones(2, 1);
      } catch (InvalidMoveException e) {
        e.printStackTrace();
      }
      assertEquals(6, data.getNumStones(7));
      assertEquals(1, data.getNumStones(6));
      assertEquals(0, data.getNumStones(2));
      assertEquals(6, data.getNumStones(11));
      try {
          rules.moveStones(12, 2);
      } catch (InvalidMoveException e) {
        e.printStackTrace();
      }
      assertEquals(2, data.getStoreCount(2));
      assertEquals(7, data.getNumStones(1));
    }
